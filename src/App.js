...
class App extends Component {
  ...
  render() {
    const {activeImg, activeTabId, score, time, isGameOver} = this.state
    return (
      <div className="app-con">
        ...
        {isGameOver ? (
          ...
          <div className="main-sec">
            <img src={activeImg} alt="imgurl" className="random-img" />
            <TabItem
              tablist={tabsList}
